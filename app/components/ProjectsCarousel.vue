      ...
      >
        <swiper-slide v-for="project in projects" :key="project.id">
          <div class="project-slide-card rounded-xl overflow-hidden cursor-pointer group"
            ...
            <div class="project-image h-56 bg-gradient-to-r from-[#32bcae] to-[#13514b] flex items-center justify-center relative overflow-hidden">
              <Icon :name="project.icon" class="text-7xl text-white group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <span class="text-white font-semibold">Voir les détails →</span>
              </div>
            </div>
            <div class="p-6">
              ...
              <p class="text-gray-400 text-sm mb-4">{{ project.shortDescription }}</p>
...
const projects = ref([
  {
    ...
    shortDescription: "API RESTful complète avec authentification et paiements",
    icon: "mdi:cart",
  ...
  },
  {
    id: 2,
    title: "Task Manager",
    shortDescription: "Application de gestion de tâches en temps réel",
    icon: "mdi:clipboard-list",
    technologies: ["Python", "FastAPI", "WebSocket", "Redis", "MongoDB", "Vue.js"]
  },
  {
    id: 3,
    title: "Notification System",
    shortDescription: "Système de microservices pour notifications",
    icon: "mdi:bell",
    technologies: ["Docker", "Kubernetes", "RabbitMQ", "Node.js", "MongoDB", "AWS"]
  },
  {
    id: 4,
...
const viewProject = (id) => {
  ...
  // À implémenter : redirection vers les détails du projet
  // navigateTo(`/projets/${id}`)
}
</script>
